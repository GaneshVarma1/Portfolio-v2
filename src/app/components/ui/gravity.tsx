...
const Gravity = forwardRef<GravityRef, GravityProps>(
  (
    ...
    const initializeRenderer = useCallback(() => {
      ...
      const walls = [
        // Floor
        Bodies.rectangle(width / 2, height - 20, width - 40, 20, {
          isStatic: true,
          friction: 1,
          render: {
            visible: debug,
        ...
        // Right wall
        Bodies.rectangle(width - 20, height / 2, 20, height - 40, {
          isStatic: true,
          friction: 1,
          render: {
            visible: debug,
        ...
        // Left wall
        Bodies.rectangle(20, height / 2, 20, height - 40, {
          isStatic: true,
          friction: 1,
          render: {
            visible: debug,
      ...
      const topWall = addTopWall
        ? Bodies.rectangle(width / 2, 20, width - 40, 20, {
            isStatic: true,
            friction: 1,
            render: {
              visible: debug,
